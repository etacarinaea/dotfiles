...
-- textclock widget
textclock = awful.widget.textclock(" %a %d %b %H:%M ", 10)
...
vicious.register(mpdwidget, vicious.widgets.mpd,
                    function (mpdwidget, args)
                        if args["{state}"] == "Stop" then
                            ...
                            return "<span color='#8D2036'> ♫</span> " .. artist .. " - " .. title
                        end
                    end, 10)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    for i = 1, #tags.names do
        awful.tag.add(tags.names[i], {
            layout = tags.layouts[i],
            gap = 15,
            screen = s
        })
    end
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey },            "d",     function () awful.util.spawn(
              "dmenu_run -fn 'tewi' -nb '" .. theme["bg_normal"] ..
              "' -nf '" .. theme["fg_normal"] .. "' -sb '" ..
              theme["fg_focus"] .. "' -sf '#fff'") end,
