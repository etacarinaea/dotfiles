...
let g:airline#themes#yuki#palette = {}
...
let s:N1   = [ '#00005f' , '#dfff00' , 238  , 229 ]
let s:N2   = [ '#ffffff' , '#444444' , 229 , 238 ]
let s:N3   = [ '#9cffd3' , '#202020' , 1  , 234 ]
...
let s:I1 = [ '#00005f' , '#00dfff' , 238  , 131  ]
let s:I2 = [ '#ffffff' , '#005fff' , 131 , 238  ]
let s:I3 = [ '#ffffff' , '#000080' , 1  , 234  ]
...
let g:airline#themes#yuki#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 234     , ''     ] ,
      \ }
let g:airline#themes#yuki#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , '#d78700' , s:I1[2] , 172     , ''     ] ,
      \ }


let g:airline#themes#yuki#palette.replace = copy(g:airline#themes#dark#palette.insert)
let g:airline#themes#yuki#palette.replace.airline_a = [ s:I2[0]   , '#af0000' , s:I2[2] , 124     , ''     ]
